...
// 入队（是否队友）只认"耐久同伴语义"。旧版把 带着/领着/跟着/跟随/护送/压阵/随身/并肩/并行
// 等纯叙事移动动词也算入队确认，导致主线人物只要"跟着主角走/带着主角去/护送一程"
// 就被自动拉进队伍（玩家反馈：只要是主线人物就会自动入队）。现收紧为：
// 明确长期同行词（同行/随行/随队/随我/随主角/同去/同往/同来/队友/同伴/结伴）
