...
import { 构建主剧情世界书作用域 } from '../../utils/worldbook';
        ...
        const builtContext = await deps.构建系统提示词(
            ...
            },
            {
                ...(recallContextActiveForMain
                    ...
                    : {}),
                世界书作用域: 构建主剧情世界书作用域(酒馆预设模式可用(规范化游戏设置(currentState.gameConfig))),
                世界书附加文本: [formatHistoryToScript(updatedContextHistory), recallTag || '']
            }
        );
